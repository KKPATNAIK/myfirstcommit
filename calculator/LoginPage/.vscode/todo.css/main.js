window.addEventListener('load', () => {
    ...
    window.addEventListener('load', () => {
        ...
        form.addEventListener('submit', (e) => {
            ...
            task_el1.appendChild(task_content_el);
            ...
            task_delete_el1.innerText = 'Delete';
    
    
           
    
            task_actions_el1.appendChild(task_edit_el1);
            ...
            task_edit_el1.addEventListener('click', (e) => {
                if (task_edit_el1.innerText.toLowerCase() == "edit") {
                    task_edit_el1.innerText = "Save";
